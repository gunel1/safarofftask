    ...
    <section class="content-header">
        ...
        <div id="stores" class="panel-heading" style="margin-right: 2%; margin-left: 0%;">
            <div class="well well-sm" style="height: 70px; width:100%; margin-left: 0%;">
                <form action="{{URL::to('/admin/blog')}}"  class="col-xs-4 col-lg-4" method="GET" class="" style="width: 70%;">
                ...
                <a class="btn btn-success" href="{{URL::to('/admin/blog/create')}}" style="height: 40px;font-size: 18px;float: right;"><i class="fa fa-plus fa-fw" style="color:white;"></i>
                </a>
                    ...
                    <div class="single-products">
                        <div class="productinfo text-center">
                            <a href="" style="font-size: 20px;color: orange;">
                                ...
                                <img src="{{ URL::to('/') }}/images/blogs/{{$blog->image->url}}" alt="text" alt=""/>  @endif
                           <hr>  {{$blog->title}}</a><p><i>{{$blog->text}}</i></p><p> @if(isset($blog->category->name)){{$blog->category->name}} @endif,@if(isset($blog->category->parentCategory->name))
                                    {{$blog->category->parentCategory->name}} @endif</p>
                        </div>
                    </div>
                    </a>
                     <div class="row">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <a href="{{ URL::to('/admin/blog/'.$blog->id.'/edit') }}" class="btn btn-danger" style="background-color: #5fbe28; border: 0;"><i class="fa fa-pencil-square-o"> </i> Edit</a>
                        </div>
