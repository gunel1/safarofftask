                        ...
                        <form class="form-horizontal form-label-left" novalidate style="margin-top: 5%; width:90%;margin-left: 5%;" action="{{ URL::to('/admin/blog/') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="item form-group" >
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="title" class="form-control col-md-7 col-xs-12"  name="title"  value="{{$blog->title}}" required="required" type="text">
                                </div>
                            </div>
                            ...
                            <div class="item form-group" >
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="text" class="form-control col-md-7 col-xs-12"  name="text"  value="{{$blog->text}}" required="required" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group" >
                                <div class="col-md-6 col-md-offset-3">
                                    ...
                                    <select  name="parent" id="parent" onchange="getChildren(this)">
                                        <option value="{{$blog->category->parentCategory->id}}">{{$blog->category->parentCategory->name}}</option>
