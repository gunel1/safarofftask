...
@section('main_content')
    <section class="content-header">
            ...
            <div class="" >
                <div class="item  " style="margin-top: 1%; box-shadow: 1px 1px 1px black;">
                    <div class="thumbnail" style="margin-top: 1%">
                        <h1 style="margin-left: 5%">Edit NEW Category </h1>
                        <hr>
                        @if (count($errors) > 0)
                        ...
                        @endif
                        <form class="form-horizontal form-label-left" novalidate style="margin-top: 5%; width:90%;margin-left: 5%;" action="{{ URL::to('/admin/category/') }}" method="post">
        ...
        <script>
            function redirect(){
                window.location="{{URL::to('/admin/category')}}";
            }
        </script>
