    ...
    <section class="content-header">
        ...
        <div id="stores" class="panel-heading" style="margin-right: 2%; margin-left: 0%;">
            <div class="well well-sm" style="height: 70px; width:100%; margin-left: 0%;">
                ...
                <a class="btn btn-success" href="{{URL::to('/admin/subcategory/create')}}" style="height: 40px;font-size: 18px;float: right;"><i class="fa fa-plus fa-fw" style="color:white;"></i>
                </a>
                    ...
                    <div class="single-products">
                     ...
                     <div class="row">
                        <div class="col-xs-12 col-md-6">
                            <form action="{{ URL::to('/admin/subcategory/'.$parent->id) }}" method="POST">
                        ...
                        <div class="col-xs-12 col-md-6">
                            <a href="{{ URL::to('/admin/subcategory/'.$parent->id.'/edit') }}" class="btn btn-danger" style="background-color: #5fbe28; border: 0;"><i class="fa fa-pencil-square-o"> </i> Edit</a>
                        </div>
