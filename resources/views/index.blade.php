	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<h1 class="brand"><a href="{{URL::to('/')}}">Maxim</a></h1>
				<!-- navigation -->
	...
	<div class="row">
		...
		<div class="span6">
			<div class="aligncenter">
				<img src="{{asset('img/icons/creativity.png')}}" alt="" />
			</div>
		</div>
	</div>
  <?php $employees=\App\Employee::all() ;?>
	...
	<div class="row">
        @foreach($employees as $employee)
            <?php $imagepath=null;
            $image=\App\Image::where('id', $employee->image_id)->first();
            if(isset($image)) $imagepath=$image->url;
            ?>
		<div class="span2 offset1 flyIn">
			<div class="people">
				<img class="team-thumb img-circle" src="{{ URL::to('/') }}/images/employees/{{$imagepath}}" alt="" />
				<h3>{{$employee->name}}</h3>
				<p>
					{{$employee->profession}}
				</p>
	...
	<div class="row">
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="{{asset('img/icons/laptop.png')}}" alt="" />
				<h2>Web design</h2>
				<p>
		...
		<div class="span3 animated flyIn">
			<div class="service-box">
				<img src="{{asset('img/icons/lab.png')}}" alt="" />
		...
		<div class="span3 animated-fast flyIn">
			<div class="service-box">
				<img src="{{asset('img/icons/camera.png')}}" alt="" />
				<h2>Photography</h2>
				<p>
					 Lorem Ipsum is simply dummy text of the printing and typesetting industry.
				</p>
		...
		<div class="span12">
			<div id="portfolio-wrap">
				...
				<div class="portfolio-item grid print photography">
					<div class="portfolio">
						<a href="{{asset('img/works/big.jpg')}}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
				...
				<div class="portfolio-item grid photography web">
					<div class="portfolio">
						<a href="{{asset('img/works/big.jpg')}}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="{{asset('img/works/9.png')}}" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
				...
				<div class="portfolio-item grid design web">
					<div class="portfolio">
						<a href="{{asset('img/works/big.jpg')}}" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
						<img src="{{asset('img/works/10.png')}}" alt="" />
						<div class="portfolio-overlay">
							<div class="thumb-info">
								<h5>Portfolio name</h5>
								<i class="icon-plus icon-2x"></i>
...
<div class="container">
	...
	<div class="row">
		<div class="span3">
			<div class="home-post">
				<div class="post-image">
					<img class="max-img" src="{{asset('img/blog/img1.jpg')}}" alt="" />
				</div>
				<div class="post-meta">
		...
		<div class="span3">
			<div class="home-post">
				<div class="post-image">
					<img class="max-img" src="{{asset('img/blog/img2.jpg')}}" alt="" />
				</div>
				<div class="post-meta">
					<i class="icon-file icon-2x"></i>
					<span class="date">June 19, 2013</span>
		...
		<div class="span3">
			<div class="home-post">
				<div class="post-image">
					<img class="max-img" src="{{asset('img/blog/img3.jpg')}}" alt="" />
				</div>
				<div class="post-meta">
					<i class="icon-file icon-2x"></i>
		...
		<div class="span3">
			<div class="home-post">
				<div class="post-image">
					<img class="max-img" src="{{asset('img/blog/img4.jpg')}}" alt="" />
				</div>
				<div class="post-meta">
					<i class="icon-file icon-2x"></i>
